...
def add_questions():
    ...
    question_6 = Question(question_text="Als je een concert mocht bijwonen van een overleden muzikant, wie zou dat dan zijn?")
    question_7 = Question(question_text="Als je een soundtrack voor je leven moest kiezen, wat zou dat dan zijn?")
    ...
    answer_7_2 = Answer(answer_text="Een vrolijke feelgood song.", question=question_7)
